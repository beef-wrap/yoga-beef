...
extension yoga
{
	...
	*/
	typealias YGLogger = function c_int(YGConfig* config, YGNode* node, YGLogLevel level,  char8* format);
	...
	*/
	typealias YGCloneNodeFunc = function YGNode*(YGNode* oldNode, YGNode* owner, c_int childIndex);
