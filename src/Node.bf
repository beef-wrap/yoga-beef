...
extension yoga
{
	...
	*/
	[CLink]
	public static extern void YGNodeInsertChild(YGNode* node, YGNode* child, c_int index);

	/**
	* Replaces the child node at a given index with a new one.
	*/
	[CLink]
	public static extern void YGNodeSwapChild(YGNode* node, YGNode* child, c_int index);
	...
	*/
	[CLink]
	public static extern void YGNodeSetChildren(YGNode* owner, YGNode** children, c_int count);

	/**
	* Get the child node at a given index.
	*/
	[CLink]
	public static extern YGNode* YGNodeGetChild(YGNode* node, c_int index);

	/**
	* The number of child nodes.
	*/
	[CLink]
	public static extern c_int YGNodeGetChildCount(YGNode* node);
